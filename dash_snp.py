...
# removendo as datas
new_data_with_feat_eng.drop(['DATE', 'Calendar.days.without.trade'], axis=1, inplace=True)
...
#undersampled_data = perform_undersample('snp', normalized_data_minmax, 'UPDOWN_SnP')
oversampled_data = perform_oversample('snp', normalized_data_minmax, 'UPDOWN_SnP')
#smote_data = perform_smote('snp', normalized_data_minmax, 'UPDOWN_SnP')
...
#
split_train_test_sets('snp', oversampled_data, 'snp', 'UPDOWN_SnP')
